          ...
          <div className="flex-1 flex items-center justify-start">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                <a href="#" className="text-white px-3 py-2 rounded-md text-sm font-medium">Become a Seller</a>
                <a href="#" className="text-white px-3 py-2 rounded-md text-sm font-medium">Download Application</a>

...
// Import your logo and avatar images here
      ...
      <div className="flex-grow relative pt-16"> {/* Added padding-top here */}
        <div className="max-w-2xl w-full p-8 bg-white rounded-lg shadow-md mx-auto my-0">
          ...
          <div className="flex flex-col items-center">
            ...
            <button className="w-full bg-red-500 text-white py-3 rounded-md font-semibold hover:bg-red-600 transition duration-300">
              Bắt đầu đăng ký
            </button>
          </div>
        </div>
